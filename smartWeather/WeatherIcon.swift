...
class WeatherIcon {
    ...
    static var IconSet = [
        ...
        WeatherIcon(regExStr: "600", parts: [WeatherIconPart(iconChar: "\u{F101}", color: UIColor(red: 0.0, green: 0.0, blue: 0.0, alpha: 1)), WeatherIconPart(iconChar: "\u{F10B}", color: UIColor(red: 0.675, green: 0.827, blue: 0.953, alpha: 1)), WeatherIconPart(iconChar: "\u{F105}", color: UIColor(red: 0.8, green: 0.8, blue: 0.8, alpha: 1))]),
